...
global.devs = '2349042566474';
global.website = 'https://wa.me/2349042566473' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/bed4793391e3a9d0d8088.jpg'
module.exports = {
  
  sessionName:  process.env.SESSION_ID ||  "SESSION ID PASTE HERE",
  botname:   process.env.BOT_NAME === undefined ? 'MCROSS-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'KING M-CROSS' : process.env.OWNER_NAME,
  author:  process.env.PACK_INFO === undefined ? 'MCROSS' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO === undefined ? 'MCROSS-Md' : process.env.PACK_INFO.split(";")[1],
...
recordingpresence:  process.env.RECORDING === undefined ? false : process.env.RECORDING,	
  ...
  HEROKU: {
    ...
    API_KEY: process.env.HEROKU_API_KEY === undefined ? 'f18e2fdc-88a6-44a2-b07b-aef0ddc87aa3' : process.env.HEROKU_API_KEY,
    APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'kingmcrossbots' : process.env.HEROKU_APP_NAME
},
  VERSION: process.env.VERSION === undefined ? 'v.0.0.3' : process.env.VERSION,
  LANG: process.env.THEME|| 'MCROSS',
